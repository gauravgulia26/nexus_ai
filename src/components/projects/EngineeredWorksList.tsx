    ...
    <div className="space-y-6 pt-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <MotionReveal delay={0.15} yOffset={25}>
          <div className="glass-panel rounded-xl p-5 space-y-4 flex flex-col justify-between h-full shadow-md">
            ...
            <div className="pt-3 border-t border-[var(--border-subtle)] flex flex-wrap gap-1 font-mono text-[10px]">
              {OTHER_PROJECTS[0].technologies.slice(0, 5).map((t, idx) => (
        ...
        <MotionReveal delay={0.2} yOffset={25}>
          <div className="glass-panel rounded-xl p-5 space-y-4 flex flex-col justify-between h-full shadow-md">
            ...
            <div className="pt-3 border-t border-[var(--border-subtle)] flex flex-wrap gap-1 font-mono text-[10px]">
              {OTHER_PROJECTS[1].technologies.map((t, idx) => (
                <span key={idx} className="px-2 py-0.5 rounded-md glass-panel-subtle text-[var(--text-secondary)]">
                  {t}
                </span>
              ))}
        ...
        <MotionReveal delay={0.25} yOffset={25}>
          <div className="glass-panel rounded-xl p-5 space-y-4 flex flex-col justify-between h-full shadow-md">
            ...
            <div className="pt-3 border-t border-[var(--border-subtle)] flex items-center justify-between">
              <span className="font-mono text-[10px] text-[var(--text-muted)]">Ensemble ROC-AUC</span>
              <a
